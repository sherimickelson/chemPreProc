...
set title "Appl * Task * Thread * - Group_0 - Unresolved\nDuration = 163.71 ms, Counter = 9.18 Mevents";
# Mean rate

set label "" at first X_LIMIT*1./FACTOR, second 56.10 point pt 3 ps 2 lc rgbcolor "#707070";
# Breakpoints
...
'scalar.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (1729)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'scalar.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleunused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Unused samples (2643)' axes x2y1 w points pt 3 lc rgbcolor '#FFA0A0',\
