...
set label "" at 163787890.0/1000000.0,0 point lt 1 ps 2 lc rgb "#FF0000";

plot \
'scalar.v1.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (783/218)' w points ls 1,\
'scalar.v1.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'Unresolved' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points ls 7;
