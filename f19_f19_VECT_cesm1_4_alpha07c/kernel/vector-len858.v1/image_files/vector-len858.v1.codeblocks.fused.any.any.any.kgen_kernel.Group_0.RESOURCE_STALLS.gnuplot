...
set title "Appl * Task * Thread * - Group_0 - kgen_kernel\nDuration = 86.50 ms, Counter = 66.39 Mevents";
# Mean rate

set label "" at first X_LIMIT*1./FACTOR, second 767.45 point pt 3 ps 2 lc rgbcolor "#707070";
# Breakpoints
...
'vector-len858.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (1000)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'vector-len858.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleunused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Unused samples (376)' axes x2y1 w points pt 3 lc rgbcolor '#FFA0A0',\
