...
plot \
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_DP_OPS($5, strcol(3), strcol(1), $2)) ti 'PAPI_DP_OPS/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_FP_INS($5, strcol(3), strcol(1), $2)) ti 'PAPI_FP_INS/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_FP_OPS($5, strcol(3), strcol(1), $2)) ti 'PAPI_FP_OPS/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_L1_TCM($5, strcol(3), strcol(1), $2)) ti 'PAPI_L1_TCM/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_L2_TCM($5, strcol(3), strcol(1), $2)) ti 'PAPI_L2_TCM/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_L3_TCM($5, strcol(3), strcol(1), $2)) ti 'PAPI_L3_TCM/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_SR_INS($5, strcol(3), strcol(1), $2)) ti 'PAPI_SR_INS/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_TLB_DM($5, strcol(3), strcol(1), $2)) ti 'PAPI_TLB_DM/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_TLB_IM($5, strcol(3), strcol(1), $2)) ti 'PAPI_TLB_IM/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_TOT_CYC($5, strcol(3), strcol(1), $2)) ti 'PAPI_TOT_CYC/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(slope_PAPI_TOT_INS($5, strcol(3), strcol(1), $2)) ti 'MIPS' axes x2y2 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_PAPI_VEC_DP($5, strcol(3), strcol(1), $2)) ti 'PAPI_VEC_DP/ins' axes x2y1 w lines lw 3,\
'vector-len8.v1.codeblocks.fused.any.any.any.slope.csv' u ($4*FACTOR):(ratio_RESOURCE_STALLS($5, strcol(3), strcol(1), $2)) ti 'RESOURCE_STALLS/ins' axes x2y1 w lines lw 3;
