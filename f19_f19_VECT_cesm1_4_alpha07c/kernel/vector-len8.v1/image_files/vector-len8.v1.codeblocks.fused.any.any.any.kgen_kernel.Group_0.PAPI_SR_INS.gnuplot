...
set title "Appl * Task * Thread * - Group_0 - kgen_kernel\nDuration = 90.14 ms, Counter = 11.08 Mevents";
# Mean rate

set label "" at first X_LIMIT*1./FACTOR, second 122.97 point pt 3 ps 2 lc rgbcolor "#707070";
# Breakpoints
...
'vector-len8.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (830)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'vector-len8.v1.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleunused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Unused samples (698)' axes x2y1 w points pt 3 lc rgbcolor '#FFA0A0',\
