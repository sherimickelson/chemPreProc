...
set label "" at 67619856.0/1000000.0,0 point lt 1 ps 2 lc rgb "#FF0000";

plot \
'vector.v2.codeblocks.fused.any.any.any.groups.csv' using (strcol(1) eq 'u' && (strcol(2) eq 'kgen_kernel' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 ti 'Group_0 (825/176)' w points ls 1,\
'vector.v2.codeblocks.fused.any.any.any.groups.csv' using ((strcol(1) eq 'e') && (strcol(2) eq 'kgen_kernel' && $3 == 1) ? $4 / 1000000.0: NaN) : $0 notitle w points ls 7;
