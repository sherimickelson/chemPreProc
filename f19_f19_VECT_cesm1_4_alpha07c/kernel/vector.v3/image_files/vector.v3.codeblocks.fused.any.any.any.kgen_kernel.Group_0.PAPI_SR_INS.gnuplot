...
set title "Appl * Task * Thread * - Group_0 - kgen_kernel\nDuration = 67.18 ms, Counter = 9.20 Mevents";
# Mean rate

set label "" at first X_LIMIT*1./FACTOR, second 137.00 point pt 3 ps 2 lc rgbcolor "#707070";
# Breakpoints
...
'vector.v3.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleexcluded($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Excluded samples (571)' axes x2y1 w points pt 3 lc rgbcolor '#A0A0A0',\
'vector.v3.codeblocks.fused.any.any.any.dump.csv' u ($4*FACTOR):(sampleunused($6, strcol(5), strcol(2), $3, strcol(1))) ti 'Unused samples (56)' axes x2y1 w points pt 3 lc rgbcolor '#FFA0A0',\
